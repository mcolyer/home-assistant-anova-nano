...
async def test_successful_config_flow(
    hass: HomeAssistant, bypass_setup, bypass_get_data
):
    """Test discovery via bluetooth with a valid device."""
    bypass_get_data("custom_components.anova_nano.config_flow")

    with patch(
        "custom_components.anova_nano.config_flow.bluetooth.async_discovered_service_info",
...
# We use the `error_on_connect` mock instead of `bypass_get_data`
